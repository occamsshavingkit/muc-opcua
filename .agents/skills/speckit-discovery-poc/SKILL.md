...
description: Derive a bounded-scope proof-of-concept and run it only when execution
...
7. Create or update `poc-result.md` beside `poc-plan.md` by rendering `.specify/templates/poc-result.md` from captured evidence and the classified result.

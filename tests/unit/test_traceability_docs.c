...
void test_traceability_docs_changed_protocol_files_have_opc_section_mappings(void) {
    static const char *const changed_protocol_files[] = {
        ...
        "src/services/node_management/add_nodes.c",
        "src/services/node_management/add_references.c",
        "src/services/node_management/delete.c",
        "src/services/query.c",
        "src/services/session.c",
        "src/services/subscription_monitor.c",
        "src/services/subscription_publish/publish.c",
        "src/services/subscription_publish/notification.c",
        "src/services/subscription_publish/deadband.c",
        "src/services/subscription_publish/retransmit.c",

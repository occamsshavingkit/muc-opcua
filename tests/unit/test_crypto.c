...
void test_sha256_known_answer(void) {
    ...
    (void)from_hex("ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad", expected);
...
void test_hmac_sha256_known_answer(void) {
    ...
    opcua_byte_t expected[MU_SHA256_LENGTH];
    (void)from_hex("b0344c61d8db38535ca8afceaf0bf12b881dc200c9833da726e9376c2e32cff7", expected);
...
void test_aes256_cbc_known_answer(void) {
    ...
    (void)from_hex("603deb1015ca71be2b73aef0857d77811f352c073b6108d72d9810a30914dff4", key);
    (void)from_hex("000102030405060708090a0b0c0d0e0f", iv);
    (void)from_hex("6bc1bee22e409f96e93d7e117393172a", pt);
    (void)from_hex("f58c4c04d6e5f1ba779eabfb5f7bfbd6", expected_ct);

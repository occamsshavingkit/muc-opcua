...
void test_aggregate_standard_nodeids_match_opcua_nodeset(void) {
    ...
    /* Every AggregateFunction_<Name> Object NodeId, verified against the OPC
       Foundation NodeIds.csv. subscription_aggregate.c dispatches on these, so a
       wrong value mis-handles a client's requested aggregate. This pins ALL of
       them (the 12 that were previously wrong were simply untested). */
    TEST_ASSERT_EQUAL_UINT32(2341u, MU_ID_AGGREGATETYPE_INTERPOLATIVE);
    TEST_ASSERT_EQUAL_UINT32(2342u, MU_ID_AGGREGATETYPE_AVERAGE);
    TEST_ASSERT_EQUAL_UINT32(2343u, MU_ID_AGGREGATETYPE_TIME_AVERAGE);
    TEST_ASSERT_EQUAL_UINT32(2344u, MU_ID_AGGREGATETYPE_TOTAL);
    TEST_ASSERT_EQUAL_UINT32(2346u, MU_ID_AGGREGATETYPE_MINIMUM);
    TEST_ASSERT_EQUAL_UINT32(2347u, MU_ID_AGGREGATETYPE_MAXIMUM);
    TEST_ASSERT_EQUAL_UINT32(2350u, MU_ID_AGGREGATETYPE_RANGE);
    TEST_ASSERT_EQUAL_UINT32(2351u, MU_ID_AGGREGATETYPE_ANNOTATION_COUNT);
    TEST_ASSERT_EQUAL_UINT32(2352u, MU_ID_AGGREGATETYPE_COUNT);
    TEST_ASSERT_EQUAL_UINT32(2357u, MU_ID_AGGREGATETYPE_START);
    TEST_ASSERT_EQUAL_UINT32(2358u, MU_ID_AGGREGATETYPE_END);
    TEST_ASSERT_EQUAL_UINT32(2359u, MU_ID_AGGREGATETYPE_DELTA);
    TEST_ASSERT_EQUAL_UINT32(2360u, MU_ID_AGGREGATETYPE_DURATION_GOOD);
    TEST_ASSERT_EQUAL_UINT32(2361u, MU_ID_AGGREGATETYPE_DURATION_BAD);
    TEST_ASSERT_EQUAL_UINT32(2362u, MU_ID_AGGREGATETYPE_PERCENT_GOOD);
    TEST_ASSERT_EQUAL_UINT32(2363u, MU_ID_AGGREGATETYPE_PERCENT_BAD);
    TEST_ASSERT_EQUAL_UINT32(2364u, MU_ID_AGGREGATETYPE_WORST_QUALITY);
    TEST_ASSERT_EQUAL_UINT32(11285u, MU_ID_AGGREGATETYPE_TIME_AVERAGE_2);
    TEST_ASSERT_EQUAL_UINT32(11286u, MU_ID_AGGREGATETYPE_MINIMUM_2);
    TEST_ASSERT_EQUAL_UINT32(11287u, MU_ID_AGGREGATETYPE_MAXIMUM_2);
    TEST_ASSERT_EQUAL_UINT32(11292u, MU_ID_AGGREGATETYPE_WORST_QUALITY_2);
    TEST_ASSERT_EQUAL_UINT32(11304u, MU_ID_AGGREGATETYPE_TOTAL_2);
    TEST_ASSERT_EQUAL_UINT32(11307u, MU_ID_AGGREGATETYPE_DURATION_IN_STATE_ZERO);
    TEST_ASSERT_EQUAL_UINT32(11507u, MU_ID_AGGREGATETYPE_DELTA_BOUNDS);
    TEST_ASSERT_EQUAL_UINT32(2348u, MU_ID_AGGREGATETYPE_MINIMUM_ACTUAL_TIME);
    TEST_ASSERT_EQUAL_UINT32(2349u, MU_ID_AGGREGATETYPE_MAXIMUM_ACTUAL_TIME);
    TEST_ASSERT_EQUAL_UINT32(2355u, MU_ID_AGGREGATETYPE_NUMBER_OF_TRANSITIONS);
    TEST_ASSERT_EQUAL_UINT32(11288u, MU_ID_AGGREGATETYPE_RANGE_2);
    TEST_ASSERT_EQUAL_UINT32(11305u, MU_ID_AGGREGATETYPE_MINIMUM_ACTUAL_TIME_2);
    TEST_ASSERT_EQUAL_UINT32(11306u, MU_ID_AGGREGATETYPE_MAXIMUM_ACTUAL_TIME_2);
    TEST_ASSERT_EQUAL_UINT32(11308u, MU_ID_AGGREGATETYPE_DURATION_IN_STATE_NON_ZERO);
    TEST_ASSERT_EQUAL_UINT32(11426u, MU_ID_AGGREGATETYPE_STANDARD_DEVIATION_SAMPLE);
    TEST_ASSERT_EQUAL_UINT32(11427u, MU_ID_AGGREGATETYPE_STANDARD_DEVIATION_POPULATION);
    TEST_ASSERT_EQUAL_UINT32(11428u, MU_ID_AGGREGATETYPE_VARIANCE_SAMPLE);
    TEST_ASSERT_EQUAL_UINT32(11429u, MU_ID_AGGREGATETYPE_VARIANCE_POPULATION);
    TEST_ASSERT_EQUAL_UINT32(11505u, MU_ID_AGGREGATETYPE_START_BOUND);
    TEST_ASSERT_EQUAL_UINT32(11506u, MU_ID_AGGREGATETYPE_END_BOUND);
}

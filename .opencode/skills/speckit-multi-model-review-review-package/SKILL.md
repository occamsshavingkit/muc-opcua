...
description: Export a compact multi-model review package for the reviewer model, including
  spec-author, implementation, subagent routing, optional Headroom-aware context compression,
  and review model metadata.
...
10. Select the reviewer template.
   ...
   - `hermes` -> `.specify/templates/hermes-review-prompt.md`

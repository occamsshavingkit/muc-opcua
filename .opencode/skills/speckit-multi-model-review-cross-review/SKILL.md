...
description: Initialize config or show status for the multi-model-review workflow,
  including spec-author, heavy-spec, implementation, review, subagent model routing,
  and optional Headroom-aware context compression.
...
8. Ask which agent is the reviewer.
   ...
   - other reviewers: `claude-code`, `gemini-cli`, `hermes`, or any custom ID with a matching `.specify/templates/<id>-review-prompt.md`

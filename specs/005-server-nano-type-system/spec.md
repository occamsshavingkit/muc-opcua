...
Add the ~16 genuinely new, non-optional nano-profile type system and Base Info
conformance unit nodes to the server's static address space. Each CU requires

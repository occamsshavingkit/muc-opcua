...
2. **Unsupported Aggregates**: If the client requests an aggregate type other than `Average` (11565), `Minimum` (11569), or `Maximum` (11570), return `Bad_MonitoredItemFilterUnsupported`.

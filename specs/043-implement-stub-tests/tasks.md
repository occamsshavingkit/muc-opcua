...
- Within US5: T015-T018 can run in parallel after T005-T006 (shared helpers)
...
T001 → T002,T003,T004 (phase 1)
  ...
  ├── T015 → T016,T017,T018 → T019 → T020 (phase 3, US5)
  ├── T021,T022,T023,T024,T025,T026,T027 → T028 → T029 → T030 (phase 4, US1)
  ├── T031,T032,T033 → T034 → T035 → T036 (phase 5, US2)
  └── T037 → T038 (phase 6, US3)
T039-T045 (phase 7, polish)
```
...
| US5 | P3 | 6 | Discovery without session (reuses mock helpers) |

...
option(MICRO_OPCUA_USER_AUTH "Build UserName/Password user identity authentication" ${MICRO_OPCUA_DEFAULT_OPTION_VAL})
option(MICRO_OPCUA_SERVICE_WRITE "Build the Write service" ${MICRO_OPCUA_DEFAULT_OPTION_VAL})
option(MICRO_OPCUA_MULTIPLE_CONNECTIONS "Support concurrent client TCP connections" ${MICRO_OPCUA_DEFAULT_OPTION_VAL})
option(MICRO_OPCUA_EVENTS "Build event and Alarm & Condition support" ${MICRO_OPCUA_DEFAULT_OPTION_VAL})
...
option(MICRO_OPCUA_CUSTOM_METHODS "Build support for custom method calls" ${MICRO_OPCUA_DEFAULT_OPTION_VAL})
option(MICRO_OPCUA_SERVER_DIAGNOSTICS "Build support for server diagnostics summary nodes" ${MICRO_OPCUA_DEFAULT_OPTION_VAL})
option(MICRO_OPCUA_DYNAMIC_NODES "Build support for AddNodes/DeleteNodes dynamic node management" ${MICRO_OPCUA_DEFAULT_OPTION_VAL})

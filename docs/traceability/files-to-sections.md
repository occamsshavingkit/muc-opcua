...
| `src/cu/core_2022_server/authorization/jwt.c` | JWT Validator | OPC-10000-4 / OPC-10000-7 | 5.7.3 / CU 1697 | Compact JWS parser, claim enforcement, alg dispatch (RFC 7519 §4, RFC 7515 §5, RFC 8725 §3) |
| `src/cu/core_2022_server/authorization/jwt.h` (public copy at `include/muc_opcua/authorization/jwt.h`) | JWT Validator | OPC-10000-4 / OPC-10000-7 | 5.7.3 / CU 1697 | Public JWT API: mu_jwt_validate, mu_jwt_claims_t, mu_jwt_result_t |
| `src/cu/core_2022_server/authorization/base64url.c` | JWT Validator | RFC 4648 / RFC 7515 | 5 / 2 | URL-safe Base64 decoder used by the JWT/JWS validator |
| `src/cu/core_2022_server/authorization/base64url.h` | JWT Validator | RFC 4648 / RFC 7515 | 5 / 2 | URL-safe Base64 decoder interface |
| `src/cu/core_2022_server/authorization/claim_scanner.c` | JWT Validator | OPC-10000-4 / OPC-10000-7 / RFC 7519 | 5.7.3 / CU 1697 / 4 | Streaming JSON claim extractor for iss/sub/aud/exp/nbf/iat |
| `src/cu/core_2022_server/authorization/claim_scanner.h` | JWT Validator | OPC-10000-4 / OPC-10000-7 / RFC 7519 | 5.7.3 / CU 1697 / 4 | Claim scanner interface |
| `src/cu/core_2022_server/authorization/crypto_jwt.c` | JWT Validator | OPC-10000-4 / OPC-10000-7 / RFC 7515 / RFC 7518 | 5.7.3 / CU 1697 / 5 / 3.1 | RSA/ECDSA verify wrapper delegating to the platform crypto backend |
| `src/cu/core_2022_server/key_credential/key_credential.c` | KeyCredential Service | OPC-10000-4 / OPC-10000-7 / OPC-10000-12 | 5.11 / CU 2113 / 8.5-8.6 | GetEncryptingKey/CreateCredential/UpdateCredential/DeleteCredential handlers + mu_key_credential_register |
...
| `src/cu/core_2022_server/certificate_manager/cert_manager.h` | Certificate Manager | OPC-10000-4 / OPC-10000-12 | 5.11 / 7.5 | Internal registration interface for `mu_certificate_manager_register` |

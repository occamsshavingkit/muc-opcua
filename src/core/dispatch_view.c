/* src/core/dispatch_view.c
 * Browse-family service handlers extracted from service_dispatch.c (T011).
 * Implements Browse (OPC-10000-4 5.9.2), BrowseNext (5.9.3), and
 * TranslateBrowsePathsToNodeIds (5.9.4). These handlers compile under
 * MUC_OPCUA_SERVICE_BROWSE; the dispatch table in service_dispatch.c
...
/* Per-request operation bounds (bounded, stack-allocated). */

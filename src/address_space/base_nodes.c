...
static const mu_node_t s_base_nodes[] = {
    ...
    {{0, MU_NODEID_NUMERIC, {2032}},
     MU_NODECLASS_VARIABLE,
     {29, s_str_SubscriptionDiagnosticsArray},
     {29, s_str_SubscriptionDiagnosticsArray},
     s_mandatory_subscriptiondiagnosticsarraytype_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2179}},
     MU_NODECLASS_VARIABLE,
     {24, s_str_MaxNotificationsPerPublish},
     {24, s_str_MaxNotificationsPerPublish},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2188}},
     MU_NODECLASS_VARIABLE,
     {26, s_str_TransferredToAltClientCount},
     {26, s_str_TransferredToAltClientCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2202}},
     MU_NODECLASS_VARIABLE,
     {19, s_str_ApplicationDescription},
     {19, s_str_ApplicationDescription},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2207}},
     MU_NODECLASS_VARIABLE,
     {24, s_str_CurrentSubscriptionsCount},
     {24, s_str_CurrentSubscriptionsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2208}},
     MU_NODECLASS_VARIABLE,
     {25, s_str_CurrentMonitoredItemsCount},
     {25, s_str_CurrentMonitoredItemsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2209}},
     MU_NODECLASS_VARIABLE,
     {28, s_str_CurrentPublishRequestsInQueue},
     {28, s_str_CurrentPublishRequestsInQueue},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2226}},
     MU_NODECLASS_VARIABLE,
     {26, s_str_DeleteMonitoredItemsCount},
     {26, s_str_DeleteMonitoredItemsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2237}},
     MU_NODECLASS_VARIABLE,
     {20, s_str_DeleteReferencesCount},
     {20, s_str_DeleteReferencesCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2240}},
     MU_NODECLASS_VARIABLE,
     {36, s_str_TranslateBrowsePathsToNodeIdsCount},
     {36, s_str_TranslateBrowsePathsToNodeIdsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2998}},
     MU_NODECLASS_VARIABLE,
     {22, s_str_EventNotificationsCount},
     {22, s_str_EventNotificationsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {8890}},
     MU_NODECLASS_VARIABLE,
     {22, s_str_CurrentKeepAliveCount},
     {22, s_str_CurrentKeepAliveCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {8893}},
     MU_NODECLASS_VARIABLE,
     {22, s_str_DiscardedMessageCount},
     {22, s_str_DiscardedMessageCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {8895}},
     MU_NODECLASS_VARIABLE,
     {25, s_str_DisabledMonitoredItemCount},
     {25, s_str_DisabledMonitoredItemCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {8902}},
     MU_NODECLASS_VARIABLE,
     {22, s_str_EventQueueOverflowCount},
     {22, s_str_EventQueueOverflowCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
...
/* spec 085 (CU 5801) Task 4: ServerType.Namespaces(11527, Optional) plus
   ...
   OperationLimitsType(11564). */
    ...
    {{0, MU_NODEID_NUMERIC, {11892}},
     MU_NODECLASS_VARIABLE,
     {22, s_str_UnauthorizedRequestCount},
     {22, s_str_UnauthorizedRequestCount},
     s_mandatory_bdv_refs,
     2,
     NULL,

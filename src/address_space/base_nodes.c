...
/* spec 094 (CU 2113): KeyCredential Service Server Facet type-system
   InstanceDeclaration BrowseNames (OPC-10000-12 §8.5-8.6). */
static const opcua_byte_t s_str_KeyCredentialConfigurationType[] = "KeyCredentialConfigurationType";
static const opcua_byte_t s_str_KeyCredentialConfigurationFolderType[] = "KeyCredentialConfigurationFolderType";
static const opcua_byte_t s_str_ResourceUri[] = "ResourceUri";
static const opcua_byte_t s_str_ProfileUri[] = "ProfileUri";
static const opcua_byte_t s_str_EndpointUrls[] = "EndpointUrls";
static const opcua_byte_t s_str_ServiceStatus[] = "ServiceStatus";
static const opcua_byte_t s_str_GetEncryptingKey[] = "GetEncryptingKey";
static const opcua_byte_t s_str_CreateCredential[] = "CreateCredential";
static const opcua_byte_t s_str_UpdateCredential[] = "UpdateCredential";
...
static const opcua_byte_t s_str_LocaleIds[] = "LocaleIds";
...
#if MUC_OPCUA_CU_KEY_CREDENTIAL_SERVICE && MUC_OPCUA_CU_BASE_INFO_TYPE_INFORMATION
/* spec 094 (CU 2113): KeyCredentialConfigurationType(17533) and
   KeyCredentialConfigurationFolderType(17496) ObjectType reference arrays
   (OPC-10000-12 §8.5-8.6). Both types are subtypes of BaseObjectType(58).
   The configuration type carries 4 mandatory Properties + the
   GetEncryptingKey Method; the folder type carries the
   <ServiceName>(17511) KeyCredentialConfiguration placeholder plus the
   three write-path Methods. Method nodes use Mandatory modelling (these
   methods are required on every instance); property nodes use
   s_mandatory_property_refs (already defined above). */
static const mu_reference_t s_keycred_config_folder_type_refs[] = {
    /* subtype of BaseObjectType */
    {{0, MU_NODEID_NUMERIC, {45}}, {0, MU_NODEID_NUMERIC, {58}}, false},
    /* <ServiceName> placeholder */
    {{0, MU_NODEID_NUMERIC, {47}}, {0, MU_NODEID_NUMERIC, {17511}}, true},
    /* CreateCredential */
    {{0, MU_NODEID_NUMERIC, {47}}, {0, MU_NODEID_NUMERIC, {17522}}, true},
    /* UpdateCredential */
    {{0, MU_NODEID_NUMERIC, {47}}, {0, MU_NODEID_NUMERIC, {17519}}, true},
    /* DeleteCredential */
    {{0, MU_NODEID_NUMERIC, {47}}, {0, MU_NODEID_NUMERIC, {17521}}, true}};

static const mu_reference_t s_keycred_config_type_refs[] = {
    /* subtype of BaseObjectType */
    {{0, MU_NODEID_NUMERIC, {45}}, {0, MU_NODEID_NUMERIC, {58}}, false},
    /* ResourceUri */
    {{0, MU_NODEID_NUMERIC, {46}}, {0, MU_NODEID_NUMERIC, {17512}}, true},
    /* ProfileUri */
    {{0, MU_NODEID_NUMERIC, {46}}, {0, MU_NODEID_NUMERIC, {17513}}, true},
    /* EndpointUrls */
    {{0, MU_NODEID_NUMERIC, {46}}, {0, MU_NODEID_NUMERIC, {17514}}, true},
    /* ServiceStatus */
    {{0, MU_NODEID_NUMERIC, {46}}, {0, MU_NODEID_NUMERIC, {17515}}, true},
    /* GetEncryptingKey */
...
static const mu_reference_t s_certificate_type_refs[] = {
    ...
    {{0, MU_NODEID_NUMERIC, {45}},
     ...
     true}, /* HasSubtype -> ApplicationCertificateType, OPC-10000-12 §7.8.4.2 */
    {{0, MU_NODEID_NUMERIC, {45}},
     {0, MU_NODEID_NUMERIC, {12558}},
     true}, /* HasSubtype -> HttpsCertificateType, OPC-10000-12 §7.8.4.3 */
    {{0, MU_NODEID_NUMERIC, {45}},
     {0, MU_NODEID_NUMERIC, {15017}},
     true}, /* HasSubtype -> UserCertificateType, OPC-10000-12 §7.8.4.4 */
    {{0, MU_NODEID_NUMERIC, {47}},
     {0, MU_NODEID_NUMERIC, {12482}},
     true}, /* HasComponent -> StartSigningRequest Method (i=12482) */
    {{0, MU_NODEID_NUMERIC, {47}},
     {0, MU_NODEID_NUMERIC, {12483}},
     true} /* HasComponent -> StartNewKeyPairRequest Method (i=12483) */
#endif
};
#endif
...
static const mu_reference_t s_cert_groups_refs[] = {
    ...
    {{0, MU_NODEID_NUMERIC, {35}},
     ...
     true}, /* Organizes -> DefaultApplicationGroup (15625), OPC-10000-12 §7.9.2 (FR-002) */
    {{0, MU_NODEID_NUMERIC, {47}},
     {0, MU_NODEID_NUMERIC, {15625}},
     true}, /* HasComponent -> DefaultApplicationGroup (15625), OPC-10000-12 §7.9.2 (FR-002) */
    {{0, MU_NODEID_NUMERIC, {35}},
     {0, MU_NODEID_NUMERIC, {15626}},
     true}, /* Organizes -> DefaultHttpsGroup (15626), OPC-10000-12 §7.9.2 (FR-002) */
    {{0, MU_NODEID_NUMERIC, {47}},
     {0, MU_NODEID_NUMERIC, {15626}},
     true}, /* HasComponent -> DefaultHttpsGroup (15626), OPC-10000-12 §7.9.2 (FR-002) */
    {{0, MU_NODEID_NUMERIC, {35}},
     {0, MU_NODEID_NUMERIC, {15627}},
     true}, /* Organizes -> DefaultUserTokenGroup (15627), OPC-10000-12 §7.9.2 (FR-002) */
    {{0, MU_NODEID_NUMERIC, {47}},
     {0, MU_NODEID_NUMERIC, {15627}},
     true} /* HasComponent -> DefaultUserTokenGroup (15627), OPC-10000-12 §7.9.2 (FR-002) */
};
...
static const mu_value_source_t s_snkp_output_value = {MU_VALUESOURCE_STATIC,
                                                      {.static_value = {.type = MU_TYPE_EXTENSIONOBJECT,
                                                                        .value = {.array = s_snkp_output_args},
                                                                        .is_array = true,
                                                                        .array_length = 1}}};
...
static const mu_node_t s_base_nodes[] = {
    ...
    {{0, MU_NODEID_NUMERIC, {2030}},
     MU_NODECLASS_VARIABLE,
     {18, s_str_SessionDiagnostics},
     {18, s_str_SessionDiagnostics},
     s_mandatory_sesdiagvariabletype_refs,
     2,
     NULL,
     .type_definition = {0, MU_NODEID_NUMERIC, {2197}},
     .value_rank = -1,
     .data_type = 865},
    {{0, MU_NODEID_NUMERIC, {2031}},
     MU_NODECLASS_VARIABLE,
     {26, s_str_SessionSecurityDiagnostics},
     {26, s_str_SessionSecurityDiagnostics},
     s_mandatory_sessecdiagtype_refs,
     2,
     NULL,
     .type_definition = {0, MU_NODEID_NUMERIC, {2244}},
     .value_rank = -1,
     .data_type = 868},
    ...
    {{0, MU_NODEID_NUMERIC, {2179}},
     MU_NODECLASS_VARIABLE,
     {26, s_str_MaxNotificationsPerPublish},
     {26, s_str_MaxNotificationsPerPublish},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2184}},
     MU_NODECLASS_VARIABLE,
     {21, s_str_RepublishRequestCount},
     {21, s_str_RepublishRequestCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2185}},
     MU_NODECLASS_VARIABLE,
     {28, s_str_RepublishMessageRequestCount},
     {28, s_str_RepublishMessageRequestCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2186}},
     MU_NODECLASS_VARIABLE,
     {21, s_str_RepublishMessageCount},
     {21, s_str_RepublishMessageCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2188}},
     MU_NODECLASS_VARIABLE,
     {27, s_str_TransferredToAltClientCount},
     {27, s_str_TransferredToAltClientCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2189}},
     MU_NODECLASS_VARIABLE,
     {28, s_str_TransferredToSameClientCount},
     {28, s_str_TransferredToSameClientCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2191}},
     MU_NODECLASS_VARIABLE,
     {28, s_str_DataChangeNotificationsCount},
     {28, s_str_DataChangeNotificationsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2206}},
     MU_NODECLASS_VARIABLE,
     {21, s_str_ClientLastContactTime},
     {21, s_str_ClientLastContactTime},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2207}},
     MU_NODECLASS_VARIABLE,
     {25, s_str_CurrentSubscriptionsCount},
     {25, s_str_CurrentSubscriptionsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2208}},
     MU_NODECLASS_VARIABLE,
     {26, s_str_CurrentMonitoredItemsCount},
     {26, s_str_CurrentMonitoredItemsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2209}},
     MU_NODECLASS_VARIABLE,
     {29, s_str_CurrentPublishRequestsInQueue},
     {29, s_str_CurrentPublishRequestsInQueue},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2222}},
     MU_NODECLASS_VARIABLE,
     {25, s_str_CreateMonitoredItemsCount},
     {25, s_str_CreateMonitoredItemsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2223}},
     MU_NODECLASS_VARIABLE,
     {25, s_str_ModifyMonitoredItemsCount},
     {25, s_str_ModifyMonitoredItemsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2224}},
     MU_NODECLASS_VARIABLE,
     {22, s_str_SetMonitoringModeCount},
     {22, s_str_SetMonitoringModeCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2226}},
     MU_NODECLASS_VARIABLE,
     {25, s_str_DeleteMonitoredItemsCount},
     {25, s_str_DeleteMonitoredItemsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2227}},
     MU_NODECLASS_VARIABLE,
     {23, s_str_CreateSubscriptionCount},
     {23, s_str_CreateSubscriptionCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2228}},
     MU_NODECLASS_VARIABLE,
     {23, s_str_ModifySubscriptionCount},
     {23, s_str_ModifySubscriptionCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2229}},
     MU_NODECLASS_VARIABLE,
     {22, s_str_SetPublishingModeCount},
     {22, s_str_SetPublishingModeCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2232}},
     MU_NODECLASS_VARIABLE,
     {26, s_str_TransferSubscriptionsCount},
     {26, s_str_TransferSubscriptionsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2233}},
     MU_NODECLASS_VARIABLE,
     {24, s_str_DeleteSubscriptionsCount},
     {24, s_str_DeleteSubscriptionsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2237}},
     MU_NODECLASS_VARIABLE,
     {21, s_str_DeleteReferencesCount},
     {21, s_str_DeleteReferencesCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2240}},
     MU_NODECLASS_VARIABLE,
     {34, s_str_TranslateBrowsePathsToNodeIdsCount},
     {34, s_str_TranslateBrowsePathsToNodeIdsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
...
/* spec 085 (CU 5801): ServerStatusType(2138) own declarations
   ...
   DataAccess-on copies below (after EnumStrings(2377) there). */
#if MUC_OPCUA_CU_BASE_INFO_SERVERTYPE && MUC_OPCUA_CU_BASE_INFO_TYPE_INFORMATION && !MUC_OPCUA_CU_DATA_ACCESS
    /* spec 092 (CU 5801): SessionDiagnosticsVariableType(2197) data-band
       children that sort in the 27xx range. DA-off copies. */
    {{0, MU_NODEID_NUMERIC, {2730}},
     MU_NODECLASS_VARIABLE,
     {18, s_str_RegisterNodesCount},
     {18, s_str_RegisterNodesCount},
     s_mandatory_bdv_refs,
     sizeof(s_mandatory_bdv_refs) / sizeof(s_mandatory_bdv_refs[0]),
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {2998}},
     MU_NODECLASS_VARIABLE,
     {23, s_str_EventNotificationsCount},
     {23, s_str_EventNotificationsCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
...
#endif
#if MUC_OPCUA_CU_BASE_INFO_SERVERTYPE && MUC_OPCUA_CU_BASE_INFO_TYPE_INFORMATION && !MUC_OPCUA_CU_DATA_ACCESS
    /* spec 092 (CU 5801): SessionDiagnosticsVariableType data-band child
       MaxResponseMessageSize(3050), UInt32. DA-off copy. */
    {{0, MU_NODEID_NUMERIC, {3050}},
     MU_NODECLASS_VARIABLE,
     {22, s_str_MaxResponseMessageSize},
     {22, s_str_MaxResponseMessageSize},
     s_mandatory_bdv_refs,
     sizeof(s_mandatory_bdv_refs) / sizeof(s_mandatory_bdv_refs[0]),
     NULL,
...
/* spec 085 (CU 5801): ServerStatusType(2138) own declarations
   ...
   (Auditing) that also fall in this range -- see the DataAccess-off
    ...
    {{0, MU_NODEID_NUMERIC, {8889}},
     MU_NODECLASS_VARIABLE,
     {23, s_str_LatePublishRequestCount},
     {23, s_str_LatePublishRequestCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {8890}},
     MU_NODECLASS_VARIABLE,
     {21, s_str_CurrentKeepAliveCount},
     {21, s_str_CurrentKeepAliveCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {8892}},
     MU_NODECLASS_VARIABLE,
     {26, s_str_UnacknowledgedMessageCount},
     {26, s_str_UnacknowledgedMessageCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {8893}},
     MU_NODECLASS_VARIABLE,
     {21, s_str_DiscardedMessageCount},
     {21, s_str_DiscardedMessageCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {8895}},
     MU_NODECLASS_VARIABLE,
     {26, s_str_DisabledMonitoredItemCount},
     {26, s_str_DisabledMonitoredItemCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {8896}},
     MU_NODECLASS_VARIABLE,
     {28, s_str_MonitoringQueueOverflowCount},
     {28, s_str_MonitoringQueueOverflowCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {8902}},
     MU_NODECLASS_VARIABLE,
     {23, s_str_EventQueueOverflowCount},
     {23, s_str_EventQueueOverflowCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
...
/* spec 085 (CU 5801) Task 4: ServerType.Namespaces(11527, Optional) plus
   ...
   OperationLimitsType(11564). */
    ...
    {{0, MU_NODEID_NUMERIC, {11892}},
     MU_NODECLASS_VARIABLE,
     {24, s_str_UnauthorizedRequestCount},
     {24, s_str_UnauthorizedRequestCount},
     s_mandatory_bdv_refs,
     2,
     NULL,
...
/* spec 090 (CU 5801 fix): ServerType.UrisVersion(15003)/VersionTime(20998)
   ...
   grounded rationale (Optional property owned by unimplemented CU 3994). */
...
#endif
#if MUC_OPCUA_CU_KEY_CREDENTIAL_SERVICE && MUC_OPCUA_CU_BASE_INFO_TYPE_INFORMATION
    /* spec 094 (CU 2113): KeyCredentialConfigurationFolderType(17496,
       OPC-10000-12 §8.6.2) -- the ObjectType that groups
       KeyCredentialConfiguration instances and exposes the write-path
       Methods (CreateCredential/UpdateCredential/DeleteCredential).
...
#endif /* MUC_OPCUA_CU_DATA_ACCESS */
#if MUC_OPCUA_CU_KEY_CREDENTIAL_SERVICE && MUC_OPCUA_CU_BASE_INFO_TYPE_INFORMATION
    /* spec 094 (CU 2113): KeyCredentialConfigurationFolderType and
       KeyCredentialConfigurationType InstanceDeclarations
       (OPC-10000-12 §8.5-8.6). NodeIds grounded against NodeIds.csv (schemas
       1.05). Sorted between EngineeringUnits(17502) and the second
    ...
    {{0, MU_NODEID_NUMERIC, {17512}},
     ...
     .type_definition = {0, MU_NODEID_NUMERIC, {68}},
     .value_rank = -1,
     .data_type = 12}, /* String (OPC-10000-12 §8.5.4) */
    {{0, MU_NODEID_NUMERIC, {17513}},
     MU_NODECLASS_VARIABLE,
     {10, s_str_ProfileUri},
     {10, s_str_ProfileUri},
     s_keycred_mandatory_property_refs,
    ...
    {{0, MU_NODEID_NUMERIC, {17514}},
     ...
     .value_rank = 1,
     .data_type = 12}, /* String[] */
    {{0, MU_NODEID_NUMERIC, {17515}},
     MU_NODECLASS_VARIABLE,
     {13, s_str_ServiceStatus},
     {13, s_str_ServiceStatus},
     s_keycred_mandatory_property_refs,
     sizeof(s_keycred_mandatory_property_refs) / sizeof(s_keycred_mandatory_property_refs[0]),
     NULL,
    ...
    {{0, MU_NODEID_NUMERIC, {17533}},
     ...
     NULL,
     .type_definition = {0}},
#endif /* MUC_OPCUA_CU_KEY_CREDENTIAL_SERVICE && MUC_OPCUA_CU_BASE_INFO_TYPE_INFORMATION */
#if MUC_OPCUA_CU_DATA_ACCESS

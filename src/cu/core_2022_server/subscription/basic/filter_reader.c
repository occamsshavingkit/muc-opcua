...
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_DURATIONINSTATEZERO) ||                                                             \
    defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_DURATIONINSTATEZERO)
...
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_MINIMUMACTUALTIME2) ||                                                              \
    defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_MINIMUMACTUALTIME2)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_MINIMUM_ACTUAL_TIME_2
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_MAXIMUMACTUALTIME2) ||                                                              \
    defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_MAXIMUMACTUALTIME2)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_MAXIMUM_ACTUAL_TIME_2
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_DURATIONINSTATENONZERO) ||                                                          \
    defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_DURATIONINSTATENONZERO)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_DURATION_IN_STATE_NON_ZERO
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_NUMBEROFTRANSITIONS) ||                                                             \
    defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_NUMBEROFTRANSITIONS)
...
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_STANDARDDEVIATIONSAMPLE) ||                                                         \
    defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_STANDARDDEVIATIONSAMPLE)
...
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_STANDARDDEVIATIONPOPULATION) ||                                                     \
    defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_STANDARDDEVIATIONPOPULATION)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_STANDARD_DEVIATION_POPULATION
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_VARIANCEPOPULATION) ||                                                              \
    defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_VARIANCEPOPULATION)

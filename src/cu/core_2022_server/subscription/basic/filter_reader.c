...
#if defined(MUC_OPCUA_CU_AGGREGATE_COUNT) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_COUNT)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_COUNT
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_RANGE) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_RANGE)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_RANGE
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_DELTA) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_DELTA)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_DELTA
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_DELTABOUNDS) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_DELTABOUNDS)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_DELTA_BOUNDS
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_DURATIONGOOD) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_DURATIONGOOD)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_DURATION_GOOD
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_DURATIONBAD) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_DURATIONBAD)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_DURATION_BAD
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_DURATIONINSTATEZERO) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_DURATIONINSTATEZERO)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_DURATION_IN_STATE_ZERO
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_START) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_START)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_START
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_END) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_END)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_END
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_INTERPOLATIVE) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_INTERPOLATIVE)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_INTERPOLATIVE
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_MAXIMUM2) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_MAXIMUM2)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_MAXIMUM_2
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_MINIMUM2) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_MINIMUM2)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_MINIMUM_2
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_PERCENTGOOD) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_PERCENTGOOD)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_PERCENT_GOOD
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_PERCENTBAD) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_PERCENTBAD)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_PERCENT_BAD
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_TIMEAVERAGE) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_TIMEAVERAGE)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_TIME_AVERAGE
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_TIMEAVERAGE2) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_TIMEAVERAGE2)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_TIME_AVERAGE_2
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_TOTAL) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_TOTAL)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_TOTAL
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_TOTAL2) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_TOTAL2)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_TOTAL_2
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_WORSTQUALITY) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_WORSTQUALITY)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_WORST_QUALITY
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_WORSTQUALITY2) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_WORSTQUALITY2)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_WORST_QUALITY_2
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_ANNOTATION_COUNT)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_ANNOTATION_COUNT
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_MINIMUMACTUALTIME) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_MINIMUMACTUALTIME)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_MINIMUM_ACTUAL_TIME
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_MAXIMUMACTUALTIME) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_MAXIMUMACTUALTIME)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_MAXIMUM_ACTUAL_TIME
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_RANGE2) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_RANGE2)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_RANGE_2
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_MINIMUMACTUALTIME2) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_MINIMUMACTUALTIME2)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_MINIMUM_ACTUAL_TIME_2
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_MAXIMUMACTUALTIME2) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_MAXIMUMACTUALTIME2)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_MAXIMUM_ACTUAL_TIME_2
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_DURATIONINSTATENONZERO) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_DURATIONINSTATENONZERO)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_DURATION_IN_STATE_NON_ZERO
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_NUMBEROFTRANSITIONS) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_NUMBEROFTRANSITIONS)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_NUMBER_OF_TRANSITIONS
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_STARTBOUND) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_STARTBOUND)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_START_BOUND
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_ENDBOUND) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_ENDBOUND)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_END_BOUND
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_STANDARDDEVIATIONSAMPLE) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_STANDARDDEVIATIONSAMPLE)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_STANDARD_DEVIATION_SAMPLE
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_VARIANCESAMPLE) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_VARIANCESAMPLE)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_VARIANCE_SAMPLE
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_STANDARDDEVIATIONPOPULATION) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_STANDARDDEVIATIONPOPULATION)
        && body->aggregate_type != MU_ID_AGGREGATETYPE_STANDARD_DEVIATION_POPULATION
#endif
#if defined(MUC_OPCUA_CU_AGGREGATE_VARIANCEPOPULATION) || defined(MUC_OPCUA_CU_AGGREGATE_SUBSCRIPTION_VARIANCEPOPULATION)
